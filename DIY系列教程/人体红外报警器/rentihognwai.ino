#include <ESP8266WiFi.h>
 WiFiClient client;
#define relay1 2 //人体红外感应模块的OUT脚连接在8266的GPIO2上
...
if(val==HIGH)
{
  client.write("mode=up&apikey=你自己的apikey&data={ck0010041}\r\n");//修改成你自己的apikey
  Serial.println("有人入侵");
 }
 if(val==LOW)
{
  client.write("mode=up&apikey=修改成你自己的apikey&data={ck0010040}\r\n");//修改成你自己的apikey
  Serial.println("无人入侵");
 }
...
     m++;
    if(m%10==0){
      client.write("mode=up&apikey=修改成你自己的apikey&data={ck001004life}\r\n");//修改成你自己的apikey
      m=0;
      }
  delay(3000);
}